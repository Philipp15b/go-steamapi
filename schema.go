...
func GetSchema(baseSteamAPIURL string, appID int, language, APIKey string) (*Schema, error) {
	getSchema := NewSteamMethod(baseSteamAPIURL, "IEconItems_"+strconv.Itoa(appID), "GetSchema", 1)
